...
namespace Proyecto_Vacunacion
{
    public partial class frmCiudadano : Form
    {
        ...
        public void agregar()
        {
            ...
            var edad = Int32.Parse(txtEdad.Text.Trim());
            ...
            if (txtDui.Text.Length <= 9 && correo.Length != 0 && direccion.Length != 0 && telefono > 20000000 && telefono < 79999999 && edad > 18)
            {
                //Insertando datos
        ...
        private void dgvCiudadano_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex != -1)
            {
                ...
                txtEdad.Text = dgvCiudadano.CurrentRow.Cells[2].Value.ToString();
                txtDireccion.Text = dgvCiudadano.CurrentRow.Cells[3].Value.ToString();
                txtTelefono.Text = dgvCiudadano.CurrentRow.Cells[4].Value.ToString();
                cmbInstitucion.Text = dgvCiudadano.CurrentRow.Cells[5].Value.ToString();
            }
        }
